...
class PerformanceTracker:
    ...
    def __init__(self, data_dir: str = "data/performance_metrics"):
        ...
        # Load existing data
        self.quali_data = self._load_json(
            self.quali_file, default={"methods": {}, "logs": [], "last_updated": None}
        )

        self.race_data = self._load_json(
            self.race_file, default={"methods": {}, "logs": [], "last_updated": None}
        )
    ...
    def get_method_performance(
        self, prediction_type: Literal["qualifying", "race"], method: str
    ) -> Dict:
        """
    ...
    def get_best_method(
        self, prediction_type: Literal["qualifying", "race"], min_samples: int = 3
    ) -> str:
        """
    ...
    def compare_methods(
        self, prediction_type: Literal["qualifying", "race"], methods: Optional[List[str]] = None
    ) -> Dict:
        """
    ...
    def _calculate_metrics(
        self, predicted: List[Dict], actual: List[Dict], prediction_type: str
    ) -> Dict:
    ...
    def _default_config(self) -> Dict:
        ...
        return {
            ...
            "uncertainty": {"base": 2.5, "reliability": 0.15, "new_regs_multiplier": 1.3},
            ...
            "default_mae": {
                ...
                "race": {"racecraft_with_tire_hierarchy": 5.5},
            },
        }
